...
------------------------------------------hso----------------------------------
if text == ("مسح قائمه العام") and Sudo_JoKeR(msg) then
redis:del(JoKeR..'GBan:User')
send(msg.chat_id_, msg.id_, '\n܁༯┆تم مسـح قائمةه العام 💞 ܰ')
return false
end

if text == ("قائمه العام") and Sudo_JoKeR(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and Sudo_JoKeR(msg) then
...
redis:sadd(JoKeR..'GBan:User', result.sender_user_id_)
...
if text and text:match("^حظر عام @(.*)$")  and Sudo_JoKeR(msg) then
...
redis:sadd(JoKeR..'GBan:User', result.id_)
else
...
if text and text:match("^حظر عام (%d+)$") and Sudo_JoKeR(msg) then
...
redis:sadd(JoKeR..'GBan:User', userid)
...
if text == ("كتم عام") and msg.reply_to_message_id_ and Sudo_JoKeR(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_, msg.id_,'- هلو حب ، لايمكنك استخدام البوت 💕.\n- ﭑشترك اولاً 💕 • ['..redis:get(JoKeR..'add:ch:username')..'] .')
return false
end
...
redis:sadd(JoKeR..'Gmute:User', result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},
function(arg,data) 
usertext = '\n܁༯┆هلو عمري 💞 ܰ'
...
if text and text:match("^كتم عام @(.*)$")  and Sudo_JoKeR(msg) then
...
status  = '\n܁༯┆تم كتم العضو عام من المجموعات  💞 ܰ'
texts = usertext..status
redis:sadd(JoKeR..'Gmute:User', result.id_)
else
texts = '܁༯┆لايوجد حساب بهذا المعرف  💞 ܰ\n'
end
send(msg.chat_id_, msg.id_, texts)
...
if text and text:match("^كتم عام (%d+)$") and Sudo_JoKeR(msg) then
...
redis:sadd(JoKeR..'Gmute:User', userid)
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and Sudo_JoKeR(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_, msg.id_,'- هلو حب ، لايمكنك استخدام البوت 💕.\n- ﭑشترك اولاً 💕 • ['..redis:get(JoKeR..'add:ch:username')..'] .')
return false
end
...
redis:srem(JoKeR..'Gmute:User', result.sender_user_id_)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
end
if text and text:match("^الغاء العام @(.*)$") and Sudo_JoKeR(msg) then
...
redis:srem(JoKeR..'Gmute:User', result.id_)
else
texts = '܁༯┆لايوجد حساب بهذا المعرف  💞 ܰ'
end
send(msg.chat_id_, msg.id_, texts)
...
if text and text:match("^الغاء العام (%d+)$") and Sudo_JoKeR(msg) then
local userid = text:match("^الغاء العام (%d+)$")
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_, msg.id_,'- هلو حب ، لايمكنك استخدام البوت 💕.\n- ﭑشترك اولاً 💕 • ['..redis:get(JoKeR..'add:ch:username')..'] .')
return false
end
redis:srem(JoKeR..'GBan:User', userid)
redis:srem(JoKeR..'Gmute:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ'
status  = '\n܁༯┆تم الغاء ܊ الحظر ٭ الكتم ܊ عام من المجموعات 💞 ܰ'
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and Sudo_JoKeR(msg) then
redis:del(JoKeR..'Sudo:User')
send(msg.chat_id_, msg.id_, "\n܁༯┆تم مسح المطورين 💞 ܰ ")
end
if text == ("المطورين") and Sudo_JoKeR(msg) then
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and Sudo_JoKeR(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_, msg.id_,'- هلو حب ، لايمكنك استخدام البوت 💕.\n- ﭑشترك اولاً 💕 • ['..redis:get(JoKeR..'add:ch:username')..'] .')
return false
end
redis:sadd(JoKeR..'Sudo:User', result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁༯┆هلو عمري 💞 ܰ'
status  = '\n܁༯┆تم رفع العضو ◃ مطور💞 ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and Sudo_JoKeR(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_, msg.id_,'- هلو حب ، لايمكنك استخدام البوت 💕.\n- ﭑشترك اولاً 💕 • ['..redis:get(JoKeR..'add:ch:username')..'] .')
return false
end
...
redis:del(JoKeR..'Basic:Constructor'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n܁༯┆تم مسح الاساسين 💞 ܰ')
return false
end

if text == 'المنشئين الاساسين' and Sudo(msg) then
local list = redis:smembers(JoKeR..'Basic:Constructor'..msg.chat_id_)
t = "\n٭ 𖤓┆قائمة الاساسيين 💞💞◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do
local username = redis:get(JoKeR.."user:Name" .. v)
if username then
...
function start_function(extra, result, success)
redis:sadd(JoKeR..'Basic:Constructor'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
...
redis:sadd(JoKeR..'Basic:Constructor'..msg.chat_id_, result.id_)
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم رفع العضو منشى اساسي 💞 ܰ'
texts = usertext..status
else
...
redis:sadd(JoKeR..'Basic:Constructor'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم رفع العضو منشى اساسي 💞 ܰ'
...
function start_function(extra, result, success)
if result.id_ then
redis:srem(JoKeR..'Basic:Constructor'..msg.chat_id_, result.id_)
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم تنزيل العضو ◃ منشى اساسي 💞 ܰ'
texts = usertext..status
else
...
redis:srem(JoKeR..'Basic:Constructor'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم تنزيل العضو ◃ منشى اساسي 💞 ܰ'
...
local list = redis:smembers(JoKeR..'Constructor'..msg.chat_id_)
t = "\n٭ 𖤓┆قائمة المنشئين 💞💞◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do
local username = redis:get(JoKeR.."user:Name" .. v)
if username then
...
local UserName = (b.username_ or "JoKeR_aHs")
...
function start_function(extra, result, success)
redis:sadd(JoKeR..'Constructor'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم رفع العضو منشى 💞 ܰ'
send(msg.chat_id_, msg.id_, usertext..status)
...
redis:sadd(JoKeR..'Constructor'..msg.chat_id_, result.id_)
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم رفع العضو منشى 💞 ܰ'
texts = usertext..status
else
...
redis:sadd(JoKeR..'Constructor'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم رفع العضو منشى 💞 ܰ'
...
function start_function(extra, result, success)
if result.id_ then
redis:srem(JoKeR..'Constructor'..msg.chat_id_, result.id_)
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم تنزيل العضو من المنشئين 💞 ܰ'
texts = usertext..status
else
...
redis:srem(JoKeR..'Constructor'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم تنزيل العضو من المنشئين 💞 ܰ'
...
local list = redis:smembers(JoKeR..'Owners'..msg.chat_id_)
t = "\n٭ 𖤓┆قائمة المدراء 💞💞◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do
local username = redis:get(JoKeR.."user:Name" .. v)
if username then
...
redis:sadd(JoKeR..'Owners'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ' 
status  = '\n܁༯┆تم رفع العضو مدير 💞 ܰ'
...
redis:srem(JoKeR..'Owners'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم تنزيل العضو من المدراء 💞 ܰ'
...
redis:sadd(JoKeR.."Mod:User"..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
redis:srem(JoKeR.."Mod:User"..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
redis:srem(JoKeR.."Mod:User"..msg.chat_id_, admins[i].user_id_)
...
function start_function(extra, result, success)
if redis:get(JoKeR..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
...
redis:sadd(JoKeR..'Mod:User'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم رفع العضو ادمن 💞 ܰ'
...
redis:srem(JoKeR..'Mod:User'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم تنزيل العضو من الادمنية ?? ܰ'
...
if redis:get(JoKeR..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
...
local list = redis:smembers(JoKeR..'Vips:User'..msg.chat_id_)
t = "\n٭ 𖤓┆قائمة المميزين 💞💞◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do
local username = redis:get(JoKeR.."user:Name" .. v)
if username then
...
redis:sadd(JoKeR..'Vips:User'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
local  statuss  = '\n܁༯┆تم رفع العضو مميز 💞 ܰ '
...
redis:srem(JoKeR..'Vips:User'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ '
status  = '\n܁༯┆تم تنزيل العضو من المميزين 💞 ܰ'
...
redis:del(JoKeR..'Ban:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n܁༯┆تم مسح المحظورين 💞 ܰ')
end
if text == ("المحظورين") then
local list = redis:smembers(JoKeR..'Ban:User'..msg.chat_id_)
t = "\n٭ 𖤓┆قائمة المحظورين 💞💞◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do
local username = redis:get(JoKeR.."user:Name" .. v)
if username then
...
redis:sadd(JoKeR..'Ban:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁༯┆ههلو عمري 💞 ܰ'
...
redis:sadd(JoKeR..'Ban:User'..msg.chat_id_, result.id_)
usertext = '\n܁༯┆ههلو عمري 💞 ܰ'
status  = '\n܁༯┆تم حظر العضو بنجاح 💞 ܰ'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
...
redis:sadd(JoKeR..'Ban:User'..msg.chat_id_, userid)
chat_kick(msg.chat_id_, userid)  
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆ههلو عمري 💞 ܰ'
...
redis:srem(JoKeR..'Ban:User'..msg.chat_id_, userid)
...
redis:del(JoKeR..'Muted:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '܁༯┆تم مسح المكتومين 💞 ܰ ')
end
if text == ("المكتومين") and Mod(msg) then
local list = redis:smembers(JoKeR..'Muted:User'..msg.chat_id_)
t = "\n٭ 𖤓┆قائمة المكتومين 😹😭💞◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do
local username = redis:get(JoKeR.."user:Name" .. v)
if username then
...
redis:sadd(JoKeR..'Muted:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁༯┆ههلو عمري 💞 ܰ'
...
redis:sadd(JoKeR..'Muted:User'..msg.chat_id_, result.id_)
usertext = '\n܁༯┆ههلو عمري 💞 ܰ'
status  = '\n܁༯┆العضو تم ◃ كتمةه ههناا  💞 ܰ' 
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
...
redis:sadd(JoKeR..'Muted:User'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ'
status  = '\n܁༯┆تم كتم العضو هنا 💞 ܰ'
...
redis:srem(JoKeR..'Muted:User'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n܁༯┆هلو عمري 💞 ܰ'
status  = '\n܁༯┆تم الغاء كتم العضو هنا 💞 ܰ'
...
redis:set(JoKeR.."Constructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"܁༯┆تم تغير رد المنشئ الى ◃ "..Teext)
end
if text and text:match("^تغير رد المدير (.*)$") and Owners(msg) then
local Teext = text:match("^تغير رد المدير (.*)$") 
redis:set(JoKeR.."Owners:Rd"..msg.chat_id_,Teext) 
send(msg.chat_id_, msg.id_,"܁༯┆تم تغير رد المدير الى ◃ "..Teext)
end
if text and text:match("^تغير رد الادمن (.*)$") and Owners(msg) then
local Teext = text:match("^تغير رد الادمن (.*)$") 
redis:set(JoKeR.."Mod:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"܁༯┆تم تغير رد الادمن الى ◃ "..Teext)
end
if text and text:match("^تغير رد المميز (.*)$") and Owners(msg) then
local Teext = text:match("^تغير رد المميز (.*)$") 
redis:set(JoKeR.."Vips:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"܁༯┆تم تغير رد المميز الى ◃ "..Teext)
end
if text and text:match("^تغير رد العضو (.*)$") and Owners(msg) then
local Teext = text:match("^تغير رد العضو (.*)$") 
redis:set(JoKeR.."Memp:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"܁༯┆تم تغير رد العضو الى ◃ "..Teext)
end
if text == 'مسح رد العضو' and Mod(msg) then
redis:del(JoKeR..'Memp:Rd'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '܁༯┆تم مسح رد العضو 💞 ܰ ')
end
if text == 'مسح رد المميز' and Mod(msg) then
redis:del(JoKeR..'Vips:Rd'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '܁༯┆تم مسح رد المميز 💞 ܰ ')
end
if text == 'مسح رد الادمن' and Mod(msg) then
redis:del(JoKeR..'Mod:Rd'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '܁༯┆تم مسح رد الادمن 💞 ܰ ')
end
if text == 'مسح رد المدير' and Mod(msg) then
redis:del(JoKeR..'Owners:Rd'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '܁༯┆تم مسح رد المدير💞 ܰ ')
end
if text == 'مسح رد المنشئ' and Mod(msg) then
redis:del(JoKeR..'Constructor:Rd'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '܁༯┆تم مسح رد المنشئ 💞 ܰ ')
end
if text == 'مسح رد المنشئ الاساسي' and Mod(msg) then
redis:del(JoKeR..'BasicConstructor:Rd'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '܁༯┆تم مسح رد المنشئ الاساسي 💞 ܰ ')
end
if text == 'مسح رد المطور' and Mod(msg) then
redis:del(JoKeR..'Sudo:Rd'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '܁༯┆تم مسح رد المطور 💞 ܰ ')
end

if text and text:match("^(.*)$") then
if redis:get(JoKeR..'help'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, '📮┆ تم حفظ الكليشه بنجاح')
redis:del(JoKeR..'help'..msg.sender_user_id_)
redis:set(JoKeR..'help_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if redis:get(JoKeR..'help1'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, '📮┆ تم حفظ الكليشه بنجاح')
redis:del(JoKeR..'help1'..msg.sender_user_id_)
redis:set(JoKeR..'help1_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if redis:get(JoKeR..'help2'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, '📮┆ تم حفظ الكليشه بنجاح')
redis:del(JoKeR..'help2'..msg.sender_user_id_)
redis:set(JoKeR..'help2_text',text)
return false
end
end

if text and text:match("^(.*)$") then
if redis:get(JoKeR..'help3'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, '📮┆ تم حفظ الكليشه بنجاح')
redis:del(JoKeR..'help3'..msg.sender_user_id_)
redis:set(JoKeR..'help3_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if redis:get(JoKeR..'help4'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, '??┆ تم حفظ الكليشه بنجاح')
redis:del(JoKeR..'help4'..msg.sender_user_id_)
redis:set(JoKeR..'help4_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if redis:get(JoKeR..'help5'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, '📮┆ تم حفظ الكليشه بنجاح')
redis:del(JoKeR..'help5'..msg.sender_user_id_)
redis:set(JoKeR..'help5_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if redis:get(JoKeR..'help6'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, '📮┆ تم حفظ الكليشه بنجاح')
redis:del(JoKeR..'help6'..msg.sender_user_id_)
redis:set(JoKeR..'help6_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if redis:get(JoKeR..'help7'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, '📮┆ تم حفظ الكليشه بنجاح')
redis:del(JoKeR..'help7'..msg.sender_user_id_)
redis:set(JoKeR..'help7_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if redis:get(JoKeR..'help8'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, '??┆ تم حفظ الكليشه بنجاح')
redis:del(JoKeR..'help8'..msg.sender_user_id_)
redis:set(JoKeR..'help8_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if redis:get(JoKeR..'help9'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, '📮┆ تم حفظ الكليشه بنجاح')
redis:del(JoKeR..'help9'..msg.sender_user_id_)
redis:set(JoKeR..'help9_text',text)
return false
end
end

if text == 'استعاده الاوامر' and Sudo_JoKeR(msg) then
redis:del(JoKeR..'help_text')
redis:del(JoKeR..'help1_text')
redis:del(JoKeR..'help2_text')
redis:del(JoKeR..'help3_text')
redis:del(JoKeR..'help4_text')
redis:del(JoKeR..'help5_text')
redis:del(JoKeR..'help6_text')
redis:del(JoKeR..'help7_text')
redis:del(JoKeR..'help8_text')
redis:del(JoKeR..'help9_text')
send(msg.chat_id_, msg.id_, '🔘┆ تم استعادة الاوامر القديمه')
end
if text == 'تغير امر الاوامر' and Sudo_JoKeR(msg) then
send(msg.chat_id_, msg.id_, '܁༯┆ارسل كليشة الامر الان ◃ 💞 ܰ')
redis:set(JoKeR..'help'..msg.sender_user_id_,'true')
return false 
end
if text == 'تغير امر م1' and Sudo_JoKeR(msg) then
send(msg.chat_id_, msg.id_, '🔘┆ الان يمكنك ارسال الكليشه م1')
redis:set(JoKeR..'help1'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م2' and Sudo_JoKeR(msg) then
send(msg.chat_id_, msg.id_, '🔘┆ الان يمكنك ارسال الكليشه م2')
redis:set(JoKeR..'help2'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م3' and Sudo_JoKeR(msg) then
send(msg.chat_id_, msg.id_, '🔘┆ الان يمكنك ارسال الكليشه م3')
redis:set(JoKeR..'help3'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م4' and Sudo_JoKeR(msg) then
send(msg.chat_id_, msg.id_, '🔘┆ الان يمكنك ارسال الكليشه م4')
redis:set(JoKeR..'help4'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م5' and Sudo_JoKeR(msg) then
send(msg.chat_id_, msg.id_, '🔘┆ الان يمكنك ارسال الكليشه م5')
redis:set(JoKeR..'help5'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م6' and Sudo_JoKeR(msg) then
send(msg.chat_id_, msg.id_, '🔘┆ الان يمكنك ارسال الكليشه م6')
redis:set(JoKeR..'help6'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م7' and Sudo_JoKeR(msg) then
send(msg.chat_id_, msg.id_, '🔘┆ الان يمكنك ارسال الكليشه م7')
redis:set(JoKeR..'help7'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م8' and Sudo_JoKeR(msg) then
send(msg.chat_id_, msg.id_, '🔘┆ الان يمكنك ارسال الكليشه م8')
redis:set(JoKeR..'help8'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م9' and Sudo_JoKeR(msg) then
send(msg.chat_id_, msg.id_, '🔘┆ الان يمكنك ارسال الكليشه م9')
redis:set(JoKeR..'help9'..msg.sender_user_id_,'true')
return false 
end
...
if redis:get(JoKeR..'Lock:Games'..msg.chat_id_) then
redis:del(JoKeR..'Set:Sma'..msg.chat_id_)
Random = {'🍏','🍎','🍐','🍊','🍋','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','??','🥐','🍞','🥨','🍟','🧀','🥚','??','🥓','🥩','🍗','🍖','🌭','🍔','🍠','🍕','🥪','🥙','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🎲','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🎟','🎫','🎗','🏵','🎖','🏆','🥌','🛷','🚗','🚌','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔','🛡','??','🌡','💣','📌','📍','??','📗','📂','📅','📪','☑','📬','📭','⏰','📺','??','☎️','📡'}
SM = Random[math.random(#Random)]
redis:set(JoKeR..'Random:Sm'..msg.chat_id_,SM)
send(msg.chat_id_, msg.id_,'܁༯┆اسرع واحد يدز لسمايل  ◃ ˼ `'..SM..'` ˹ 💞 ܰ')
return false
end
end
if text == ''..(redis:get(JoKeR..'Random:Sm'..msg.chat_id_) or '')..'' and not redis:get(JoKeR..'Set:Sma'..msg.chat_id_) then
if not redis:get(JoKeR..'Set:Sma'..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'܁༯┆ويانا فائز ككلللوش 😂😭💞 ܰ')
redis:incrby(JoKeR..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(JoKeR..'Set:Sma'..msg.chat_id_,true)
return false
end 
...
if redis:get(JoKeR..'Lock:Games'..msg.chat_id_) then
redis:del(JoKeR..'Speed:Tr'..msg.chat_id_)
KlamSpeed = {'سحور','سياره','استقبال','قنفه','ايفون','بزونه','مطبخ','كرستيانو','دجاجه','مدرسه','الوان','غرفه','ثلاجه','كهوه','سفينه','العراق','محطه','طياره','رادار','منزل','مستشفى','كهرباء','تفاحه','اخطبوط','سلمون','فرنسا','برتقاله','تفاح','مطرقه','بتيته','لهانه','شباك','باص','سمكه','ذباب','تلفاز','حاسوب','انترنيت','ساحه','جسر'};
name = KlamSpeed[math.random(#KlamSpeed)]
redis:set(JoKeR..'Klam:Speed'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(redis:get(JoKeR..'Klam:Speed'..msg.chat_id_) or '')..'' and not redis:get(JoKeR..'Speed:Tr'..msg.chat_id_) then
if not redis:get(JoKeR..'Speed:Tr'..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'܁༯┆ويانا فائز ككلللوش 😂😭💞 ܰ')
redis:incrby(JoKeR..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(JoKeR..'Speed:Tr'..msg.chat_id_,true)
end 
...
if redis:get(JoKeR..'Lock:Games'..msg.chat_id_) then
redis:del(JoKeR..'Set:Hzora'..msg.chat_id_)
...
redis:set(JoKeR..'Klam:Hzor'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(redis:get(JoKeR..'Klam:Hzor'..msg.chat_id_) or '')..'' and not redis:get(JoKeR..'Set:Hzora'..msg.chat_id_) then
if not redis:get(JoKeR..'Set:Hzora'..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'܁༯┆ويانا فائز ككلللوش 😂😭💞 ܰ')
redis:incrby(JoKeR..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(JoKeR..'Set:Hzora'..msg.chat_id_,true)
end 
...
if redis:get(JoKeR..'Lock:Games'..msg.chat_id_) then
redis:del(JoKeR..'Set:Maany'..msg.chat_id_)
Maany_Rand = {'قرد','دجاجه','بطريق','ضفدع','بومه','نحله','ديك','جمل','بقره','دولفين','تمساح','قرش','نمر','اخطبوط','سمكه','خفاش','اسد','فأر','ذئب','فراشه','عقرب','زرافه','قنفذ','تفاحه','باذنجان'}
name = Maany_Rand[math.random(#Maany_Rand)]
redis:set(JoKeR..'Maany'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(redis:get(JoKeR..'Maany'..msg.chat_id_) or '')..'' and not redis:get(JoKeR..'Set:Maany'..msg.chat_id_) then
if not redis:get(JoKeR..'Set:Maany'..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'܁༯┆ويانا فائز ككلللوش 😂😭💞 ܰ')
redis:incrby(JoKeR..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(JoKeR..'Set:Maany'..msg.chat_id_,true)
end 
if text == 'العكس' then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_, msg.id_,'- هلو حب ، لايمكنك استخدام البوت 💕.\n- ﭑشترك اولاً 💕 • ['..redis:get(JoKeR..'add:ch:username')..'] .')
...
if redis:get(JoKeR..'Lock:Games'..msg.chat_id_) then
redis:del(JoKeR..'Set:Aks'..msg.chat_id_)
katu = {'باي','فهمت','موزين','اسمعك','احبك','موحلو','نضيف','حاره','ناصي','جوه','سريع','ونسه','طويل','سمين','ضعيف','شريف','شجاع','رحت','عدل','نشيط','شبعان','موعطشان','خوش ولد','اني','هادئ'}
name = katu[math.random(#katu)]
redis:set(JoKeR..'Set:Aks:Game'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(redis:get(JoKeR..'Set:Aks:Game'..msg.chat_id_) or '')..'' and not redis:get(JoKeR..'Set:Aks'..msg.chat_id_) then
if not redis:get(JoKeR..'Set:Aks'..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'܁༯┆ويانا فائز ككلللوش 😂😭💞 ܰ')
redis:incrby(JoKeR..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(JoKeR..'Set:Aks'..msg.chat_id_,true)
end 

if redis:get(JoKeR.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
send(msg.chat_id_, msg.id_,"܁༯┆ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }💞 ܰ\n")
return false  end 
local GETNUM = redis:get(JoKeR.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
redis:del(JoKeR..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
redis:del(JoKeR.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
redis:incrby(JoKeR..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,5)  
send(msg.chat_id_, msg.id_,'܁༯┆ مبروك فزت ويانه وخمنت الرقم الصحيح 💞 ܰ\n܁༯┆ تم اضافة { 5 } من النقاط 💞 ܰ\n')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
redis:incrby(JoKeR..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(redis:get(JoKeR..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
redis:del(JoKeR..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
redis:del(JoKeR.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
redis:set(JoKeR.."GAMES:NUM"..msg.chat_id_,Num) 
...
redis:setex(JoKeR.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
end

if redis:get(JoKeR.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
send(msg.chat_id_, msg.id_,"܁༯┆عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى 💞 ܰ\n")
return false  end 
local GETNUM = redis:get(JoKeR.."Games:Bat"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
redis:del(JoKeR.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,'܁༯┆ويانا فائز ككلللوش 😂😭💞 ܰ')
redis:incrby(JoKeR..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
redis:del(JoKeR.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
if redis:get(JoKeR..'Lock:Games'..msg.chat_id_) then   
Num = math.random(1,6)
redis:set(JoKeR.."Games:Bat"..msg.chat_id_,Num) 
TEST = [[
...
redis:setex(JoKeR.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
end
...
redis:del(JoKeR..'Set:Moktlf:Bot'..msg.chat_id_)
redis:set(JoKeR..':Set:Moktlf'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(redis:get(JoKeR..':Set:Moktlf'..msg.chat_id_) or '')..'' then 
if not redis:get(JoKeR..'Set:Moktlf:Bot'..msg.chat_id_) then 
redis:del(JoKeR..':Set:Moktlf'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'܁༯┆ويانا فائز ككلللوش ??😭💞 ܰ')
redis:incrby(JoKeR..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(JoKeR..'Set:Moktlf:Bot'..msg.chat_id_,true)
end
------------------------------------------------------------------------
...
redis:del(JoKeR..'Set:Ryadeat:Bot'..msg.chat_id_)
redis:set(JoKeR..':Set:Ryadeat'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(redis:get(JoKeR..':Set:Ryadeat'..msg.chat_id_) or '')..'' then 
if not redis:get(JoKeR..'Set:Ryadeat:Bot'..msg.chat_id_) then 
redis:del(JoKeR..':Set:Ryadeat'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'܁༯┆ويانا فائز ككلللوش 😂😭💞 ܰ')
redis:incrby(JoKeR..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(JoKeR..'Set:Ryadeat:Bot'..msg.chat_id_,true)
end
------------------------------------------------------------------------
...
name = Hussein[math.random(#Hussein)]
redis:del(JoKeR..'Set:English:Bot'..msg.chat_id_)
redis:set(JoKeR..':Set:English'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(redis:get(JoKeR..':Set:English'..msg.chat_id_) or '')..'' then 
if not redis:get(JoKeR..'Set:English:Bot'..msg.chat_id_) then 
redis:del(JoKeR..':Set:English'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'܁༯┆ويانا فائز ككلللوش 😂😭💞 ܰ')
redis:incrby(JoKeR..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(JoKeR..'Set:English:Bot'..msg.chat_id_,true)
end
------------------------------------------------------------------------
...
redis:set(JoKeR..'Set:Amth'..msg.chat_id_,name)
redis:del(JoKeR..'Set:Amth:Bot'..msg.chat_id_)
...
------------------------------------------------------------------------
if text == ''..(redis:get(JoKeR..'Set:Amth'..msg.chat_id_) or '')..'' then 
if not redis:get(JoKeR..'Set:Amth:Bot'..msg.chat_id_) then 
redis:del(JoKeR..'Set:Amth'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'܁༯┆ويانا فائز ككلللوش 😂😭💞 ܰ')
redis:incrby(JoKeR..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set(JoKeR..'Set:Amth:Bot'..msg.chat_id_,true)
end
if text == 'تعطيل الالعاب' and Owners(msg) then  
send(msg.chat_id_, msg.id_, '\n܁༯┆ههلو عمري 💞 ܰ \n܁༯┆تم تعطيل الالعاب 💞 ܰ')
redis:del(JoKeR..'Lock:Games'..msg.chat_id_) 
end
if text == 'تفعيل الالعاب' and Owners(msg) then  
send(msg.chat_id_, msg.id_, '܁༯┆ههلو عمري 💞 ܰ \n܁༯┆تم تفعيل الالعاب 💞 ܰ')
redis:set(JoKeR..'Lock:Games'..msg.chat_id_,true) 
end

if text == 'الالعاب' or text == 'اللعبه' and redis:get(JoKeR..'Lock:Games'..msg.chat_id_) then
Text_Games = [[
٭ 𖤓┆قائمة الالعاب 💞◟
܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀
...
local help_text = redis:get(JoKeR..'help_text')
Text = [[
܁༯┆ اهلا بيك عمري 💞 . 
܁༯┆اوامر البوت ▾ . 
܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀
...
܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀
𖤂┆[CHanneL SourcE](t.me/JoKeR_aHs) 𖥠 .
]]
